...
def run():
    ...
    ap.add_argument("-east", "--east", type=str,
        default="frozen_east_text_detection.pb", help="path to input EAST text detector")
    ...
    net = cv2.dnn.readNet("/Users/Guillaume/frozen_east_text_detection.pb")
    ...
    while True:
        ...
        try:
            ...
            val = re.search('[a-zA-Z]{3,}',text) # only extract if there is at least 3 or more characters
            if val[0].isalpha():
                print("\033[1m✅ Extracted Text ({})\033[0m".format(i))
                print(text)
        except:
            pass
